            ...
            <div class="gallery__inner inner">
                ...
                <div class="gallery__wrapper">
                    <picture class="gallery__wrapper-item">
                        <source media="(min-width: 1240px)" srcset="<?php echo esc_url(get_template_directory_uri() . '/images/gallery__item-1-1440.jpg'); ?> ">
                        <source media="(max-width: 1239px)" srcset="<?php echo esc_url(get_template_directory_uri() . '/images/gallery__item-1-768.png'); ?> ">
                    ...
                    <picture class="gallery__wrapper-item">
                        <source media="(min-width: 1240px)" srcset="<?php echo esc_url(get_template_directory_uri() . '/images/gallery__item-2-1440.jpg'); ?> ">
                        <source media="(max-width: 1239px)" srcset="<?php echo esc_url(get_template_directory_uri() . '/images/gallery__item-2-768.png'); ?> ">
                    ...
                    <picture class="gallery__wrapper-item">
                        <source media="(min-width: 1240px)" srcset="<?php echo esc_url(get_template_directory_uri() . '/images/gallery__item-3-1440.jpg'); ?> ">
                        <source media="(max-width: 1239px)" srcset="<?php echo esc_url(get_template_directory_uri() . '/images/gallery__item-3-768.png'); ?> ">
                    ...
                    <picture class="gallery__wrapper-item">
                        <source media="(min-width: 1240px)" srcset="<?php echo esc_url(get_template_directory_uri() . '/images/gallery__item-4-1440.jpg'); ?> ">
                        <source media="(max-width: 1239px)" srcset="<?php echo esc_url(get_template_directory_uri() . '/images/gallery__item-4-768.png'); ?> ">
                    ...
                    <picture class="gallery__wrapper-item">
                        <source media="(min-width: 1240px)" srcset="<?php echo esc_url(get_template_directory_uri() . '/images/gallery__item-5-1440.png'); ?> ">
                        <source media="(max-width: 1239px)" srcset="<?php echo esc_url(get_template_directory_uri() . '/images/gallery__item-5-768.png'); ?> ">
                    ...
                    <picture class="gallery__wrapper-item">
                        <source media="(min-width: 1240px)" srcset="<?php echo esc_url(get_template_directory_uri() . '/images/gallery__item-6-1440.jpg'); ?> ">
                        <source media="(max-width: 1239px)" srcset="<?php echo esc_url(get_template_directory_uri() . '/images/gallery__item-6-768.png'); ?> ">
